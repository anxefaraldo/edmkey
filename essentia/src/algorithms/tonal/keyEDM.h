...
class KeyEDM : public Algorithm {
 ...
 public:
  ...
  void declareParameters() {
    declareParameter("profileType", "the type of polyphic profile to use for correlation calculation", "{temperley,shaath,edma,edmm}", "edma");
...
class KeyEDM : public AlgorithmComposite {
 ...
 public:
  ...
  void declareParameters() {
    declareParameter("profileType", "the type of polyphohic profile to use for correlation calculation", "{temperley,shaath,edma,edmm}", "edma");
    declareParameter("pcpSize", "number of array elements used to represent a semitone times 12 (this parameter is only a hint, during computation, the size of the input PCP is used instead)", "[12,inf)", 36);
  }
